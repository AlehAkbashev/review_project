# Generated by Django 3.2 on 2023-10-30 21:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(message='Slug doesnt correct', regex='^[-a-zA-Z0-9_]+$')], verbose_name='category_slug')),
            ],
        ),
        migrations.CreateModel(
            name='Genres',
            fields=[
                ...
                ('slug', models.CharField(max_length=50, unique=True, verbose_name='genres_slug')),
            ],
        ),
        migrations.CreateModel(
            name='Title',
